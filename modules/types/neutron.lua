...
---@field tell fun(pack: string, event: string, client: neutron.class.client, bytes: any) Отправляет событие event с данными bytes моду pack на сторону указанного клиента client.
---@field echo fun(pack: string, event: string, bytes: any) Отправляет событие event с данными bytes моду pack всем подключённым клиентам.
---@field on fun(pack: string, event: string, func: fun(client: neutron.class.client, bytes: any)) Регистрирует функцию func, которая будет вызвана при получении события event от мода pack. В функцию передаются данные bytes и Client, с которого пришло сообщение
...
---@field send fun(pack: string, event: string, bytes: any) Отправляет событие event с данными bytes моду pack на сервер.
---@field on fun(pack: string, event: string, func: fun(bytes: any)) Регистрирует функцию func, которая будет вызвана при получении события event от мода pack. В функцию передаются данные bytes.
